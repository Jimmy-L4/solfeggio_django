...
define('modules/NoteEdition/src/NoteEditionController',[
   ...
   */
  NoteEditionController.prototype._isWholeTupletSelected = function (
    noteIndex
  ) {
    if (isNaN(noteIndex)) {
      throw (
  ...
  NoteEditionController.prototype._fitsInBar = function (tmpNm) {
    ...
    var barBeatDuration = this.songModel
      .getTimeSignatureAt(numBar)
      .getQuarterBeats()
    var barRelativeBeat =
      initBeat - this.songModel.getStartBeatFromBarNumber(numBar)
  ...
  NoteEditionController.prototype._getSelectedNotes = function () {
    var noteManager = this.songModel.getComponent('notes')
    var selectedNotes = noteManager.getNotes(
      this.cursor.getStart(),
      this.cursor.getEnd() + 1
    )
  ...
  NoteEditionController.prototype._cloneSelectedNotes = function () {
    ...
    var selectedNotes = nm.cloneElems(
      this.cursor.getStart(),
      this.cursor.getEnd() + 1
    )
   ...
   */
  NoteEditionController.prototype._checkDuration = function (
    noteMng,
    tmpNm,
    durBefore,
    durAfter
    ...
    if (durAfter < durBefore) {
      divisions = this.songModel.getBarDivisionsBetweenBeats(
        initBeat + durAfter,
        initBeat + durBefore
      )
  ...
  NoteEditionController.prototype._runDurationFn = function (fn) {
    ...
    var tmpBeatInterval = noteMng.getBeatIntervalByIndexes(
      tmpCursorPos[0],
      tmpCursorPos[1]
    )
...
/**
  ...
  NoteEditionController.prototype.addAccidental = function (accidental) {
    ...
    var note
    if (
      typeof doubleAccidental !== 'undefined' &&
  ...
  NoteEditionController.prototype.setCurrDuration = function (duration) {
    ...
    this._runDurationFn(function (tmpNm) {
      ...
      if (typeof newDur === 'undefined') {
        throw (
          'NoteEditionController - setCurrDuration not accepted duration ' +
          duration
        )
      }
    ...
    this._runDurationFn(function (tmpNm) {
      ...
      function createTupletFromNotes(arrNotes, timeModif) {
        var firstNote = arrNotes[0],
          ...
          newDuration =
            arrNotes.length == 1
              ? firstNote.getDuration() / 2
              : firstNote.getDuration()
        tupletsNote = []
      ...
      if (selNotes.length < 3) {
        if (!validDur(selNotes)) {
          return {
            error:
              'Select notes with a simple duration (not dotted or tuplet notes)',
          }
        }
      }
  ...
  NoteEditionController.prototype.setSilence = function () {
    ...
    this._runDurationFn(function (tmpNm) {
      ...
      for (var i = 0; i < selNotes.length; i++) {
        ...
        if (
          self._isWholeTupletSelected(self.cursor.getStart() + i) &&
          note.isTuplet()
        ) {
          ...
          if (note.isTuplet('start')) {
            ...
            deleteNoteTupletToDo =
              note.getTimeModification().split('/')[0] -
              note.getTimeModification().split('/')[1]
  ...
  NoteEditionController.prototype.copyNotes = function () {
    this._ifTupletExpandCursor()
    var noteManager = this.songModel.getComponent('notes')
    this.buffer = noteManager.cloneElems(
      this.cursor.getStart(),
      this.cursor.getEnd() + 1
    )
  }
  ...
  NoteEditionController.prototype.moveCursorByBar = function (inc) {
    ...
    var noteManager = this.songModel.getComponent('notes')
    var barNum = noteManager.getNoteBarNumber(
      this.cursor.getPos()[0],
      this.songModel
    )
...
define('text!modules/NoteEdition/src/NoteEditionTemplate.html',[],function () { return '<div id="edit_notes_second_level">\n  <div id="edit_pitch_container">\n    <div id="edit_each_pitch_container">\n      <div class="current_button" title="Add 1 ton (+)" id="aug-note">+</div>\n      <div class="current_button" title="Substract 1 ton (-)" id="sub-note">\n        -\n      </div>\n    </div>\n    <div class="button_text">改变音高</div>\n  </div>\n  <div id="edit_alteration_container">\n    <div id="edit_each_alteration_container">\n      <div\n        class="current_button"\n        title="Double Flat (Shift+V)"\n        id="double_flat"\n      >\n        <img src="{{imgPath}}/double_flat.png" alt="double_flat" />\n      </div>\n      <div class="current_button" title="Flat (V)" id="flat">&#9837;</div>\n      <div class="current_button" title="Natural (N)" id="natural">&#9838;</div>\n      <div class="current_button" title="Sharp (S)" id="sharp">&#9839;</div>\n      <div\n        class="current_button"\n        title="Double Sharp (Shitf+S)"\n        id="double_sharp"\n      >\n        <img src="{{imgPath}}/double_sharp.png" alt="double_sharp" />\n      </div>\n    </div>\n    <div class="button_text">升降符号</div>\n  </div>\n  <div id="edit_rhythm_container">\n    <div id="edit_each_rhythm_container">\n      <div\n        class="current_button"\n        id="sixty-four-note"\n        title="Sixty-four note (1)"\n      >\n        <img src="{{imgPath}}/sixty-four-note.png" alt="1/64" />\n      </div>\n      <div\n        class="current_button"\n        id="thirty-second-note"\n        title="Thirty-second note (2)"\n      >\n        <img src="{{imgPath}}/thirty-second-note.png" alt="1/32" />\n      </div>\n      <div\n        class="current_button"\n        id="sixteenth-note"\n        title="Sixteenth note (3)"\n      >\n        <img src="{{imgPath}}/sixteenth-note.png" alt="1/16" />\n      </div>\n      <div class="current_button" id="eight-note" title="Eight note (4)">\n        <img src="{{imgPath}}/eight-note.png" alt="1/8" />\n      </div>\n      <div class="current_button" id="quarter-note" title="Quarter note (5)">\n        <img src="{{imgPath}}/quarter-note.png" alt="1/4" />\n      </div>\n      <div class="current_button" id="half-note" title="Half note (6)">\n        <img src="{{imgPath}}/half-note.png" alt="1/2" />\n      </div>\n      <div class="current_button" id="whole-note" title="Whole note (7)">\n        <img src="{{imgPath}}/whole-note.png" alt="1" />\n      </div>\n      <div class="current_button" id="dot" title="dot (.)">.</div>\n      <div class="current_button" id="double-dot" title="Double dot (:)">\n        ..\n      </div>\n    </div>\n    <div class="button_text">时值</div>\n  </div>\n  <div id="edit_symbol_container">\n    <div id="edit_each_symbol_container">\n      <div class="current_button" id="tie-note" title="Tie note (T)">\n        <img src="{{imgPath}}/tie-note.png" alt="tie" />\n      </div>\n      <div class="current_button" id="tuplet" title="Tuplet (Shift+T)">\n        <img src="{{imgPath}}/tuplet.png" alt="tuplet" />\n      </div>\n    </div>\n    <div class="button_text">连音/延音</div>\n  </div>\n  <div id="edit_note_container">\n    <div id="edit_each_note_container">\n      <div class="current_button" id="regular-note" title="Regular mode (D)">\n        <img src="{{imgPath}}/quarter-note.png" alt="regular" />\n      </div>\n      <div class="current_button" id="silent-note" title="Silent mode (R)">\n        <img src="{{imgPath}}/silent.png" alt="silent" />\n      </div>\n      <div class="current_button" id="delete-note" title="Remove note (Del)">\n        <img src="{{imgPath}}/remove.png" alt="delete" />\n      </div>\n      <div class="current_button" id="add-note" title="Add note (Space)">\n        <img src="{{imgPath}}/add.png" alt="add" />\n      </div>\n    </div>\n    <div class="button_text">单音</div>\n  </div>\n  <div id="selection_container">\n    <div id="edit_each_selection_container">\n      <div class="current_button" id="delete-pitch" title="Remove pitch">\n        <img src="{{imgPath}}/remove.png" alt="delete" />\n      </div>\n      <div class="current_button" id="add-pitch" title="Add pitch">\n        <img src="{{imgPath}}/add.png" alt="add" />\n      </div>\n    </div>\n    <div class="button_text">复音</div></div>\n  </div>\n</div>\n';});
...
define('modules/FileEdition/src/FileEditionController',[
  ...
  FileEditionController.prototype.save = function (
    ...
    if (this.saveFn !== undefined) {
      if (
        showConfirm &&
        !confirm(
          'Are you sure you want to save the changes in ' +
  ...
  FileEditionController.prototype.update = function () {
    var songId
    if (this.songModel._id !== undefined) {
      songId = this.songModel._id
    }
    this.songModel._id = undefined // we need to clean songModel id otherwise update doesn't work
    var JSONSong = SongModel_CSLJson.exportToMusicCSLJSON(this.songModel)
